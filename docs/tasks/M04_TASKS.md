Below is **Milestone 4 – “Visual Hand Play”** fully laid‑out for your agents.
As before, each task begins with the branch context and ends with an explicit
**“run & validate”** reminder.

---

## 1 • Mini‑PRD  `docs/prds/M04_VISUAL_HAND_PLAY.md`
...
## 2 • Task Cards  `docs/tasks/M04_TASKS.md`
